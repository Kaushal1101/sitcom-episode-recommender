...
from backend.cli_utils import data_root, list_episode_ids, parse_episode_id, resolve_series
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.episode_id:
        series_slug, _, _ = parse_episode_id(args.episode_id)
    ...
    for episode_id in episode_ids:
        out_path = raw_data_root / episode_id / "mood_enriched.json"
        ...
        try:
            result = enrich_episode(episode_id, raw_data_root, classifier)
